...
# keeping runtime data on the mounted volumes.  Do not walk either dependency
# tree: package files are already readable, and traversing them is very slow on
# the NAS overlay filesystem.
RUN find /app -path /app/node_modules -prune -o -path /app/standalone/node_modules -prune -o -type d -exec chmod a+rx {} + \
    && find /app -path /app/node_modules -prune -o -path /app/standalone/node_modules -prune -o -type f -exec chmod a+r {} +
EXPOSE 3000
