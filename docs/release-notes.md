...
历史验证记录见 [归档验证日志](archive/validation-log.md)。最近一次 `pnpm test:all` 已通过 integration 8 个文件/25 个测试、scoring 5 个文件/22 个测试、全量 Vitest 13 个文件/47 个测试、Python/notebook、构建和 3 个 E2E 测试，并包含仓库发布卫生门。
